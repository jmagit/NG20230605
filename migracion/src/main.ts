...
import { LoggerService, ERROR_LEVEL } from 'src/lib/my-core';


bootstrapApplication(AppComponent, {
    providers: [
        importProvidersFrom(BrowserModule, FormsModule, MainModule, SecurityModule, AppRoutingModule, ContactosModule),
        LoggerService,
